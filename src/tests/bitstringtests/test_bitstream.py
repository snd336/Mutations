...
class FromFile(unittest.TestCase):
    ...
    def testCreationFromFileWithLength(self):
        ...
        file_path = (os.path.dirname(__file__)) + '/smalltestfile'
...
class Split(unittest.TestCase):
    ...
    def testAutoFromFileObject(self):
        file_path = (os.path.dirname(__file__)) + '/test.m1v' # My changes
        with open(file_path, 'rb') as f:
    ...
    def testFileBasedCopy(self):
        file_path = (os.path.dirname(__file__)) + '/smalltestfile'  # My changes
        with open(file_path, 'rb') as f:
            s = BitStream(f)
            t = BitStream(s)
            s.prepend('0b1')
