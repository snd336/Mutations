...
from src.mutpy import codegen, coverage, utils
from src.mutpy.operators import *
...
class MutationOperatorTest(unittest.TestCase):
    class PassIdOperator(MutationOperator):
...
class ArithmeticOperatorReplacementTest(OperatorTestCase):
    ...
    @classmethod
    def setUpClass(cls):
        cls.op = ArithmeticOperatorReplacement()
...
class AssignmentOperatorReplacementTest(OperatorTestCase):
    ...
    @classmethod
    def setUpClass(cls):
        cls.op = AssignmentOperatorReplacement()
...
class ArithmeticOperatorDeletionTest(OperatorTestCase):
    ...
    @classmethod
    def setUpClass(cls):
        cls.op = ArithmeticOperatorDeletion()
...
class LogicalOperatorReplacementTest(OperatorTestCase):
    ...
    @classmethod
    def setUpClass(cls):
        cls.op = LogicalOperatorReplacement()
...
class LogicalOperatorDeletionTest(OperatorTestCase):
    ...
    @classmethod
    def setUpClass(cls):
        cls.op = LogicalOperatorDeletion()
...
class LogicalConnectorReplacementTest(OperatorTestCase):
    ...
    @classmethod
    def setUpClass(cls):
        cls.op = LogicalConnectorReplacement()
...
class RelationalOperatorReplacementTest(OperatorTestCase):
    ...
    @classmethod
    def setUpClass(cls):
        cls.op = RelationalOperatorReplacement()
...
class ConditionalOperatorInsertionTest(OperatorTestCase):
    ...
    @classmethod
    def setUpClass(cls):
        cls.op = ConditionalOperatorInsertion()
...
class ConditionalOperatorDeletionTest(OperatorTestCase):
    ...
    @classmethod
    def setUpClass(cls):
        cls.op = ConditionalOperatorDeletion()
...
class ExceptionHandlerDeletionTest(OperatorTestCase):
    ...
    @classmethod
    def setUpClass(cls):
        cls.op = ExceptionHandlerDeletion()
...
class MutateOnlyCoveredNodesTest(OperatorTestCase):
    ...
    def test_not_covered_except_handler_node(self):
        self.assert_mutation('try:' + EOL + INDENT + 'raise' + EOL + 'except:' + EOL + INDENT + 'try:' + EOL +
                             ...
                             operator=ExceptionHandlerDeletion(),
                             with_coverage=True)
...
class OverridingMethodDeletionTest(OperatorTestCase):
    ...
    @classmethod
    def setUpClass(cls):
        cls.op = OverridingMethodDeletion()
...
class OverriddenMethodCallingPositionChangeTest(OperatorTestCase):
    ...
    @classmethod
    def setUpClass(cls):
        cls.op = OverriddenMethodCallingPositionChange()
...
class BreakContinueReplacementTest(OperatorTestCase):
    ...
    @classmethod
    def setUpClass(cls):
        cls.op = BreakContinueReplacement()
...
class StaticmethodDecoratorInsertionTest(OperatorTestCase):
    ...
    @classmethod
    def setUpClass(cls):
        cls.op = StaticmethodDecoratorInsertion()
